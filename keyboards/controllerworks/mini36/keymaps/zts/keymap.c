...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------|
      LT(NUMP, KC_ESC), LT(MOVE, KC_TAB), LT(WNDW, KC_BSPC),  KC_ENT, LT(SYMB, KC_SPC), LT(RAISE, KC_ESC)
                            //`--------------------------'  `--------------------------'
  ...
  //|--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------|
RCTL_T(KC_TAB), KC_LALT, KC_LGUI, KC_LSFT, XXXXXXX,                      XXXXXXX, KC_RSFT, KC_RGUI, KC_LALT, RCTL_T(KC_QUOT),
  //|--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------|
  ...
  //|--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------|
      KC_EQL,  KC_MINS, KC_LPRN, KC_RPRN, KC_PLUS,                      KC_DLR,  KC_EXLM, _______, _______, KC_QUOT,
  //|--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------|
