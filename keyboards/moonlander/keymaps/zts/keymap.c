...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[MOVE] = LAYOUT_moonlander_wrapper(
		...
		_______, KC_UNDO, KC_CUT,  KC_COPY, KC_PASTE,_______,                           KC_END,  KC_PGDN, KC_PGUP, KC_HOME, _______, _______,
	...
	[WNDW] = LAYOUT_moonlander_wrapper(
		...
		_______, _______, _______, _______, _______, _______, _______,         _______, _______, KC_KP_7, _______, KC_KP_9, _______, _______,
		_______, _______, _______, _______, _______, _______, _______,         _______, KC_KP_4, KC_KP_2, KC_KP_8, KC_KP_6, KC_KP_5, _______,
		_______, _______, _______, _______, _______, _______,                           _______, KC_KP_1, _______, KC_KP_3, _______, _______,
		_______, _______, _______, _______, _______,      _______,                  _______,     _______, _______, _______, _______, _______,
												_______, _______, _______,   _______, _______, _______
	),
	...
	[NUMP] = LAYOUT_moonlander_wrapper(
		...
		_______, _______, _______, _______, _______, _______, _______,         _______, XXXXXXX, KC_KP_4, KC_KP_5, KC_KP_6, KC_PPLS, _______,
